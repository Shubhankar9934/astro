...
def create_bullish_researcher(llm, memory: FinancialSituationMemory):
    def bull_node(state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = f"""You are a Bull Analyst advocating for investing in the stock. Build a strong evidence-based case.
Resources:
